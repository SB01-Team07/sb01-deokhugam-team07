...
public class GlobalExceptionHandler {
  ...
  private HttpStatus determineHttpStatus(DeokhugamException exception) {
    ...
    return switch (errorCode) {
      case BOOK_NOT_FOUND, REVIEW_NOT_FOUND, COMMENT_NOT_FOUND, NOTIFICATION_NOT_FOUND,
           OCR_ISBN_NOT_FOUND -> HttpStatus.NOT_FOUND;
      case DUPLICATE_BOOK, DUPLICATE_REVIEW, DUPLICATE_STORAGE -> HttpStatus.CONFLICT;
      ...
      case INVALID_REVIEW_REQUEST, INVALID_COMMENT_CURSOR, INVALID_COMMENT_DIRECTION,
           INVALID_COMMENT_SORT_BY, INVALID_SORT_FIELD, STORAGE_INIT, STORAGE_SAVE_FAILED,
           OCR_PROCESSING_FAILED -> HttpStatus.BAD_REQUEST;
